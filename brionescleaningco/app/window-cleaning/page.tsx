...
export const metadata = {
  ...
  description: "Interior and exterior window cleaning for homes and businesses in Raleigh, Durham, and the Triangle. Streak-free results guaranteed — 919-973-9643.",
}
