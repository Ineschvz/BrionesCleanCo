...
export const metadata = {
  ...
  description: "Deep carpet and upholstery cleaning in Raleigh, Durham, and the Triangle. Hot water extraction removes stains, allergens, and odors. Free estimates — 919-973-9643.",
}
